...
class TemplatesVC: UIViewController {
    ...
    private lazy var firstViewController:  ListOfTemplatesVC = {
        // Load Storyboard
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        
        // Instantiate View Controller
        var viewController = storyboard.instantiateViewController(withIdentifier: "ListOfTemplatesVC") as! ListOfTemplatesVC
    ...
    private lazy var secondViewController: InvoiceTemplateVC = {
        // Load Storyboard
        let storyboard = UIStoryboard(name: "Main", bundle: Bundle.main)
        
        // Instantiate View Controller
        var viewController = storyboard.instantiateViewController(withIdentifier: "InvoiceTemplateVC") as! InvoiceTemplateVC
