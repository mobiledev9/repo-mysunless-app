...
//            self.sideMenuViewController.view.topAnchor.constraint(equalTo: view.topAnchor)
            self.sideMenuViewController.view.topAnchor.constraint(equalTo: view.topAnchor, constant: -1)
        ])
...
//        view.addGestureRecognizer(panGestureRecognizer)
        ...
        // Default Main View Controller
          showViewController(storyboardId: "DashboardVC")
...
extension MainVC: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        switch row {
            case 0:
                // Home
                self.showViewController(storyboardId: "DashboardVC")
            case 1:
                // Clients
                print("Clients")
...
//                present(safariVC, animated: true)
  ...
  /*  func showwViewController<T: UIViewController>(viewController: T.Type, storyboardId: String) -> () {
...
//        if storyboardId == "ClientsVC" {
//            let dashboardvc = DashboardVC()
//            dashboardvc.clients = true
//        }
        vc.view.tag = 99
    ...
    func showViewController(storyboardId: String) -> () {
        ...
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: storyboardId) as! DashboardVC
       // vc.clients = true
        vc.view.tag = 99
        view.insertSubview(vc.view, at: self.revealSideMenuOnTop ? 0 : 1)
        addChild(vc)
...
extension MainVC: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        TapGestureRecognizer(sender: gestureRecognizer as! UITapGestureRecognizer)
        return true
    }
    
    // Dragging Side Menu
 /*   @objc private func handlePanGesture(sender: UIPanGestureRecognizer) {
        gua rd gestureEnabled == true else { return }
